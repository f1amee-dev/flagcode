...
import { type ProjectId, type ThreadId } from "@flagcode/contracts";
import { create } from "zustand";

const PERSISTED_STATE_KEY = "flagcode:ui-state:v1";
const LEGACY_PERSISTED_STATE_KEYS = [
  "flagcode:ui-state:v1",
  "flagcode:renderer-state:v8",
  "flagcode:renderer-state:v7",
  "flagcode:renderer-state:v6",
  "flagcode:renderer-state:v5",
  "flagcode:renderer-state:v4",
  "flagcode:renderer-state:v3",
