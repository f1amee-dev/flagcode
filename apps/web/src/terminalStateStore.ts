...
import { parseScopedThreadKey, scopedThreadKey } from "@flagcode/client-runtime";
import { type ScopedThreadRef, type TerminalEvent } from "@flagcode/contracts";
...
const TERMINAL_STATE_STORAGE_KEY = "flagcode:terminal-state:v1";
