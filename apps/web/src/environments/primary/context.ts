...
import type { EnvironmentId, ExecutionEnvironmentDescriptor } from "@flagcode/contracts";
...
const SERVER_ENVIRONMENT_DESCRIPTOR_PATH = "/.well-known/flagcode/environment";
