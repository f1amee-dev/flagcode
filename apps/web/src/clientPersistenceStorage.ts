...
export const CLIENT_SETTINGS_STORAGE_KEY = "flagcode:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "flagcode:saved-environment-registry:v1";
