import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@flagcode/contracts";
...
import { KeybindingsConfigError } from "@flagcode/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "flagcode-keybindings-test-",
        }),
      ),
    ),
  );
