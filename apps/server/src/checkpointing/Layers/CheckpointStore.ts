...
import { CheckpointRef } from "@flagcode/contracts";
...
const makeCheckpointStore = Effect.gen(function* () {
  ...
  const captureCheckpoint: CheckpointStoreShape["captureCheckpoint"] = Effect.fn(
    ...
    yield* Effect.acquireUseRelease(
      fs.makeTempDirectory({ prefix: "flagcode-fs-checkpoint-" }),
      Effect.fn("captureCheckpoint.withTempDirectory")(function* (tempDir) {
        ...
        const commitEnv: NodeJS.ProcessEnv = {
          ...
          GIT_AUTHOR_NAME: "FlagCode",
          GIT_AUTHOR_EMAIL: "flagcode@users.noreply.github.com",
          GIT_COMMITTER_NAME: "FlagCode",
          GIT_COMMITTER_EMAIL: "flagcode@users.noreply.github.com",
        };
