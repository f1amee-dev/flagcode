...
import { GitCommandError, type GitBranch } from "@flagcode/contracts";
import { dedupeRemoteBranchesWithLocalMatches } from "@flagcode/shared/git";
...
import { decodeJsonResult } from "@flagcode/shared/schemaJson";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `flagcode-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
