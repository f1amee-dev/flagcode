...
import { CodexModelSelection } from "@flagcode/contracts";
...
import { normalizeCodexModelOptionsWithCapabilities } from "@flagcode/shared/model";
...
const makeCodexTextGeneration = Effect.gen(function* () {
  ...
  const writeTempFile = (
    ...
    return fileSystem
      .makeTempFileScoped({
        prefix: `flagcode-${prefix}-${process.pid}-${randomUUID()}.tmp`,
      })
      .pipe(
