// This file mostly exists because we want dev mode to say "FlagCode (Dev)" instead of "electron"
...
const APP_BUNDLE_ID = isDevelopment ? "com.flagcode.flagcode.dev" : "com.flagcode.flagcode";
